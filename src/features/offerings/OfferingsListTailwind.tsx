...
type Props = {
  replaceWithOfferings: Offering[];
  onRfqButtonClick: (offering: Offering) => void;
};

export function OfferingsListTailwind({
  replaceWithOfferings,
  onRfqButtonClick,
}: Props) {
  return (
    <ul className="divide-y divide-white/5">
      {offerings.map((offering) => (
        ...
        >
          ...
          <div className="text-gray-400">Request Quote</div>
          <ChevronRightIcon
